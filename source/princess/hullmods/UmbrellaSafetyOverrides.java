...
public class UmbrellaSafetyOverrides extends SafetyOverrides {
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		super.applyEffectsBeforeShipCreation(HullSize.DESTROYER, stats, id);
	}
	*/
public class UmbrellaSafetyOverrides extends BaseHullMod {
...
//	}
	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		stats.getMaxSpeed().modifyFlat(id, (Float) speed.get(HullSize.DESTROYER));
		stats.getAcceleration().modifyFlat(id, (Float) speed.get(HullSize.DESTROYER) * 2f);
		stats.getDeceleration().modifyFlat(id, (Float) speed.get(HullSize.DESTROYER) * 2f);
